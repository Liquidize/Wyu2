...
using FriendRadar.Ui;

namespace FriendRadar;

/// <summary>Entry point: wires the trackers, the relay and the windows together.</summary>
public sealed class Plugin : IDalamudPlugin
{
    private const string MainCommand = "/friendradar";
    private const string ShortCommand = "/frad";
    ...
    private readonly WindowSystem windows = new("FriendRadar");
    ...
    public Plugin(IDalamudPluginInterface pluginInterface)
    {
        ...
        dtrEntry = Service.DtrBar.Get("FriendRadar", "FriendRadar");
        ...
        {
            HelpMessage = "Alias for /friendradar.",
            ShowInHelp = false,
        });
    ...
    private void OnFrameworkUpdate(Dalamud.Plugin.Services.IFramework framework)
    {
        ...
        {
            Service.Log.Error(ex, "FriendRadar update failed");
        }
    }
    ...
    private void OnFriendChangedZone(TrackedFriend friend, string zoneName)
    {
        ...
        Service.Chat.Print($"{friend.Name} is now in {(string.IsNullOrWhiteSpace(zoneName) ? "another zone" : zoneName)}.", "FriendRadar");
    }
    ...
    private void OnCommand(string command, string arguments)
    {
        ...
        switch (verb)
        {
            ...
            case "note":
                ...
                config.Save();
                hub.PublishNow();
                Service.Chat.Print(string.IsNullOrEmpty(rest) ? "Status note cleared." : $"Status note set to \"{rest}\".", "FriendRadar");
                break;
    ...
    private void SetSharing(string argument)
    {
        ...
        Service.Chat.Print(enable ? "Sharing your presence." : "Stopped sharing.", "FriendRadar");
    }
    ...
    private void Pause(string argument)
    {
        ...
        config.Save();
        Service.Chat.Print($"Sharing paused for {minutes} minute(s).", "FriendRadar");
    }
}
