...
public static class ProtocolConstants
{
    ...
    public const string ProtocolVersionHeader = "X-FriendRadar-Protocol";

    /// <summary>Header the client uses to announce its plugin version (diagnostics only).</summary>
    public const string ClientVersionHeader = "X-FriendRadar-Client";
    ...
    public const string KeyDerivationInfo = "FriendRadar/v1/presence";
}
